...
## 🎖️ Core Areas Covered & Technical Skills

### Security Operations Center (SOC)
- Security monitoring and event analysis
- SIEM technologies and log management
...
- Firewalls and network protection technologies
- IDS/IPS systems
...
- Risk management in hybrid infrastructures
...
### Digital Forensics
- Forensic acquisition and preservation
...
- AI Agents and Security Operations
- Phishing and malware detection using ML
